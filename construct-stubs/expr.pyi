...
class ExprMixin(t.Generic[ReturnType], object):
    ...
    @t.overload
    def __add__(
        self: ExprMixin[bool], other: ConstOrCallable[bool]
    ) -> BinExpr[int]: ...
    @t.overload
    def __add__(
        self: ExprMixin[float], other: ConstOrCallable[int]
    ) -> BinExpr[float]: ...
    @t.overload
    def __add__(
        self: ExprMixin[float], other: ConstOrCallable[bool]
    ) -> BinExpr[float]: ...
    @t.overload
    def __add__(
        self: ExprMixin[float], other: ConstOrCallable[float]
    ) -> BinExpr[float]: ...
    @t.overload
    ...
    @t.overload
    def __floordiv__(
        self: ExprMixin[int], other: ConstOrCallable[int]
    ) -> BinExpr[int]: ...
    @t.overload
    def __floordiv__(
        self: ExprMixin[int], other: ConstOrCallable[bool]
    ) -> BinExpr[int]: ...
    @t.overload
    def __floordiv__(
        self: ExprMixin[bool], other: ConstOrCallable[int]
    ) -> BinExpr[int]: ...
    @t.overload
    def __floordiv__(
        self: ExprMixin[bool], other: ConstOrCallable[bool]
